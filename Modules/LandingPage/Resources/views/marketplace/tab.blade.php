...
{{-- <a href="{{ route('marketplace_embed_url',$slug) }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'marketplace_embed_url') ? ' active' : '' }}">{{ __('Embed Url') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a> --}}
