                                        ...
                                        <td class="Action ignore">
                                            <div class="d-flex gap-1 justify-content-end">
                                                ...
                                                {{-- @permission('Show Customer') --}}
                                                    <a href="{{ route('customer.show', $customer->id) }}"
                                                        class="btn btn-sm btn-icon btn-info" data-bs-placement="top" data-bs-toggle="tooltip"
                                                        title="{{__('Cart') }}">
                                                        <i class="ti ti-shopping-cart "></i>
                                                    </a>
                                                {{-- @endpermission --}}
                                                @php
                                                    $module = Nwidart\Modules\Facades\Module::find('RewardClubPoint');
                                                @endphp
                                                @if (isset($module) && $module->isEnabled())
                                                    @include('rewardclubpoint::admin.clubPointHistoryBtn', ['customerId' => $customer->id])
                                                @endif
                                            </div>
                                        </td>
                                        <td class="Action ignore">
