                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto justify-content-end d-flex">
                                        <a href="javascript::void(0);" data-size="lg" data-url="{{ route('dedicated_theme_section_create',$slug) }}" data-ajax-popup="true"  data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Section')}}"  class="btn btn-sm btn-primary">
                                            ...
                                            @endphp
                                                @foreach (($dedicated_theme_sections) as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="landigpage_action_link">
                                                                <div class="d-flex gap-1">
                                                                    <a href="#" class="btn btn-sm btn-info bg-info" data-url="{{ route('dedicated_theme_section_edit',[$slug,$key]) }}" data-ajax-popup="true" data-title="{{__('Edit Page')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                                                        <i class="ti ti-pencil"></i>
                                                                    </a>
                                                                    {!! Form::open(['method' => 'GET', 'route' => ['dedicated_theme_section_delete',[$slug, $key]],'id'=>'delete-form-'.$key]) !!}

                                                                        <a href="#" class="btn btn-sm btn-danger bg-danger show_confirm" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm-yes="{{'delete-form-'.$key}}">
