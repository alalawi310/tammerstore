        ...
        <div class="card-footer">
            ...
            <div class="row">
                <div class="col-sm-12 text-end">
                    <button class="btn btn-primary add-new-slider-btn">{{__('Add New Slider')}}</button>
                    <button class="btn btn-danger delete-slider-btn" @if(isset($json_data->loop_number) && $json_data->loop_number < 4) disabled="true" @endif>{{__('Delete Slider')}}</button>
                </div>
            </div>
            @endif
        </div>
