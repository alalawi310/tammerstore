                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('Select Menus', __('Select Menus'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-md-4 form-group">
                                    {{ Form::label('Enable Menus', __('Enable Menus'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        {{ Form::label('Drop-Down View', __('Drop-Down View'), ['class' => 'form-label']) }}
                                        <div class="form-check form-switch mx-2">
                                            <input type="checkbox" class="form-check-input" id="cust-theme-bg"
                                                name="enable_dropdown"
                                                {{ isset($menusettings->enable_dropdown) && $menusettings->enable_dropdown == 'on' ? 'checked="checked"' : '' }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
