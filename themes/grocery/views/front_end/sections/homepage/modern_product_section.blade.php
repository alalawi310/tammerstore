                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6 col-12 bestseller-item product-card">
                            <div class="product-card-inner">
                                <div class="product-card-image">
                                    <a href="product.html">
                                        <img src="{{ get_file('themes/' . $currentTheme . '/assets/images/best-pro1.png'),$currentTheme }}" class="default-img">
                                        <img src="{{ get_file('themes/' . $currentTheme . '/assets/images/best-pro1-hover.png'),$currentTheme }}" class="hover-img">
                                    </a>
                                    <div class="new-labl">
                                        -20%
                                    </div>
