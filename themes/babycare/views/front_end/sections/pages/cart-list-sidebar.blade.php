            ...
            <div class="mini-cart-item">
                ...
                <div class="mini-cart-details">
                    ...
                    <div class="qty-spinner">
                        ...
                        <input type="hidden" name="product_id" value="{{ old('product_id') ?? 45 }}">
                        <input type="text" class="quantity 45_quatity" data-cke-saved-name="quantity" name="quantity" value="{{ $item->qty }}" min="01" id="cart_list_sidebar_quantity{{ $item->qty }}" data-id="463" disabled>
