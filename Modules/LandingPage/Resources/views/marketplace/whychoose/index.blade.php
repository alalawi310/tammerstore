                                    ...
                                    <div class="row" >
                                            ...
                                            @foreach (json_decode($settings['pricing_plan_text'] ,true) as $key => $title)
                                                <div id="{{ 'add-cards'.$key }}" class="border-bottom row py-2">
                                                    ...
                                                    <div class="col-2 d-flex text-center align-items-center">
                                                        <a href="#" id="{{ 'delete-card'.$key }}" class="card-delete btn btn-danger btn-sm bg-danger" title="{{__('Delete')}}" data-title="{{__('Delete')}}" data-original-title="{{__('Delete')}}">
                                        ...
                                        @else
                                            <div id="add-cards1" class="border-bottom row py-2">
                                                ...
                                                <div class="col-2 d-flex text-center align-items-center">
                                                    <a href="#" id="{{ 'delete-card1' }}" class="card-delete btn btn-danger btn-sm bg-danger" title="{{__('Delete')}}" data-title="{{__('Delete')}}" data-original-title="{{__('Delete')}}">
                                                        <i class="ti ti-trash"></i>
                                                    </a>
                                                </div>
                                            </div>
