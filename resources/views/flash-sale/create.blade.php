        ...
        <div class="row">
            @for ($i = 0; $i <= 0; $i++)
                <div class="row filter-css mt-2 form-group-container"
                    ...
                    <div class="col-md-4">
                        <div class="btn-box">
                            {!! Form::select('fields[' . $i . '][condition_option]', App\Models\FlashSale::$options, old('fields.' . $i . '.condition_option'), [
                    ...
                    <div class="col-xl-3 col-lg-2 col-md-6 col-sm-12 col-12 mr-2">
                        <div class="btn-box condition">
                            {!! Form::select('fields[' . $i . '][condition]', App\Models\FlashSale::$condition, old('fields.' . $i . '.condition'), [
                                'class' => 'form-control',
                                'placeholder' => 'Select option',
                            ]) !!}
                        </div>
