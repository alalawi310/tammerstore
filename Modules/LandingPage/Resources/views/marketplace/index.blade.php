                                    ...
                                    @foreach ($plans as $key =>$plan)
                                        <div class="tab-content {{ $key == 0 ? 'active' : '' }}" id="{{ $key }}">
                                            <div class="pricing-content">
                                                <div class="price">
                                                    <ins><span class="currency-type">{{ trim(default_currency_format_with_sym($plan->price)) }}</span> <span class="time-lbl text-muted">{{ $plan->duration }}</span></ins>
                                                </div>
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                <div class="product-card-inner">
                                    ...
                                    <div class="product-content">
                                        ...
                                        {{-- <div class="price">
                                            <ins><span class="currency-type">{{ default_currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                        <ins><span class="currency-type">{{ default_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                        </div> --}}
