    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    @endif
                    @if (auth()->user()->type == 'admin')
                        @stack('sms_setting_sidebar')
                        @stack('coupon_setting_sidebar')
                        @stack('StoreLocatorSidebar')
                    @endif
                    ...
                    @if (auth()->user()->type == 'admin')
                        ...
                        @stack('recentViewTab')
                        @stack('frequentlyproductTab')
                        @stack('tawktoTab')
                        @stack('wizzchatTab')
                        @stack('BadgeTab')
                        @stack('add-linkedin-sidebar')
                        @stack('add-twitter-sidebar')
                        @stack('slack_setting_sidebar')
                        @stack('facebook_setting_sidebar')
                        @stack('gitSigninTab')
                        @stack('googleLoginTab')
                        @stack('add-bitbucket-sidebar')
                        @stack('settingTab')
                        @stack('print_setting_sidebar')
                    @endif
        ...
        <div class="col-xl-9">
                                ...
                                <div
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group col-8 switch-width">
                                            ...
                                            <select name="s3_storage_validation[]" data-role="tagsinput"
                                                id="s3_storage_validation" multiple>
                                                @foreach ($file_type as $f)
                                                    <option @if (in_array($f, explode(',', isset($setting['s3_storage_validation']) ? $setting['s3_storage_validation'] : null))) selected @endif>
                                                        {{ $f }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group col-8 switch-width">
                                            ...
                                            <select name="wasabi_storage_validation[]" data-role="tagsinput"
                                                id="wasabi_storage_validation" multiple>
                                                @foreach ($file_type as $f)
                                                    <option @if (in_array(
                                                            $f,
                                                            explode(',', isset($setting['wasabi_storage_validation']) ? $setting['wasabi_storage_validation'] : null))) selected @endif>
                                                        {{ $f }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-6 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <label class="custom-control-label form-control-label"
                                                                    for="is_bank_transfer_enabled">{{__('Bank Transfer
                                                                    Enabled')}}</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['stripe_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['razorpay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['mercado_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['skrill_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['paymentwall_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Enter App ID"
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                <label for="tap_secret_key"
                                                                    class="col-form-label">{{ __('Secret Key') }}</label>
                                                                <input class="form-control"
                                                                    placeholder="Enter Secret Key" name="tap_secret_key"
                                                                    type="text"
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Enter Salt Key"
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="CinetPay SECRET KEY"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['cinet_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="SenangPay Merchant Id"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="SenangPay SECRET KEY"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['senang_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="CyberSource Merchant Id"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="CyberSource SECRET KEY"
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="CyberSource API KEY"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['cybersource_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Ozow Site KEY"
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Ozow API KEY"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['ozow_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="MyFatoorah Country ISO"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['myfatoorah_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['easebuzz_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control"
                                                                        placeholder="Enter NMI Api Private Key"
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="payu_salt_key"
                                                                    class="col-form-label">{{ __('Salt Key') }}</label>
                                                                <input class="form-control" placeholder="Salt Key"
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div id="paynow_pay_merchant_email" class="col-md-6"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="Paynow Merchant Email"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['paynow_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="sofort Publishable Key"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="sofort Secret"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['sofort_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="esewa_merchant_key"
                                                                    ...
                                                                    placeholder="{{ __('esewa Access Token') }}" />
                                                                @if ($errors->has('esewa_secret_key'))
                                                                    <span class="invalid-feedback d-block">
                                                    ...
                                                    <div class="mt-2 row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset($setting['dpo_pay_image'] ?? '') }}"
                                                                    class="img-center img-fluid"
                                                                    style="max-height: 100px;">
                                                            </div>
                                                        </div>
            ...
            @endif
					@if (auth()->user()->type == 'admin')
					<!-- SMS Setting  -->
					@stack('sms_setting_sidebar_div')

					<!-- Coupon Setting  -->
					@stack('coupon_setting_sidebar_div')
                    @stack('StoreLocatorSidebarSection')
					@endif
            {{-- Tax Option Setting --}}
            @if (auth()->user()->type == 'admin' && $plan && ($plan->enable_tax == 'on'))
        ...
        @endif
            ...
            @if (auth()->user()->type == 'admin')
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        @stack('frequentlyproductTabForm')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('tawktoTabForm')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('wizzchatTabForm')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('BadgeTabForm')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('add-linkedin-setting')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('add-twitter-setting')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('slack_setting_sidebar_form')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('facebook_setting_sidebar_form')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('gitSigninTabForm')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('googleLoginTabForm')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('add-bitbucket-setting')
                    </div>
                    <div class="col-sm-12 col-md-12">
                        @stack('settingTabForm')
                    </div>
                </div>
            @endif
            ...
            @stack('print_setting_sidebar_content')
        </div>
    </div>
@endsection
