            ...
            <div class="card">
                <div class="card-body package-card-inner  d-flex align-items-center">
                    <div class="package-itm ">
                        <a href="https://tammerofficial.com/?utm_source=ecom-main-file&utm_medium=superadmin&utm_campaign=superadmin-btn-theme-all" target="new">
                    ...
                    <div class="price text-end">
                        <a class="btn btn-primary" href="https://tammerofficial.com/product-category/theme-addon/?utm_source=ecom-main-file&utm_medium=superadmin&utm_campaign=superadmin-btn-theme-all" target="new">
                            {{ __('Themes Addon') }}
                        </a>
                    </div>
                </div>
