@php
    ...
    $menusettings = \Modules\LandingPage\Entities\OwnerMenuSetting::where('created_by', $superadmin->id)->first();
...
<head>
    <title>
    {{ \App\Models\Utility::GetValueByName('title_text', APP_THEME(), 1) ? \App\Models\Utility::GetValueByName('title_text', APP_THEME(), 1) : (env('APP_NAME') ?? 'Tammer store') }}
    </title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <!-- font css -->
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/fonts/tabler-icons.min.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/fonts/feather.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/fonts/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/fonts/material.css') }}" />

    <!-- vendor css -->
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/style.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/customizer.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/landing-page.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/custom.css') }}" />
    <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/assets/swiper/dist/css/swiper-bundle.min.css') }}" />

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/style-rtl.css') }}" />
    @elseif (isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on')
        <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/style-dark.css') }}" />
    @else
        <link rel="stylesheet" href="{{ url('Modules/LandingPage/Resources/assets/css/style.css') }}"
            id="main-style-link" />
    @endif
...
@if (isset($settings['feature_status']) && $settings['feature_status'] == 'on')
    <section class="features-section section-gap bg-dark landing-feature" id="features">
        <div class="container">
            <div class="row gy-3">
                <div class="col-xxl-4">
...
@if (isset($settings['discover_status']) && $settings['discover_status'] == 'on')
    <section class="bg-dark section-gap landing-feature">
        <div class="container">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 mb-5">
                        <div class="card price-card shadow-none {{ $key == 2 ? 'bg-dark' : '' }}"
                            ...
                            <div class="card-body">
                                ...
                                @if ($setting['SIGNUP'] == 'on')
                                    <div class="d-grid">
                                        <a href="{{ route('register', ['plan_id' => $value->id]) }}" class="btn btn-primary rounded-pill">{{__('Start with Starter')}} <i data-feather="log-in" class="ms-2"></i> </a>
                                    </div>
                                @endif
                            </div>
                        </div>
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        {{-- <p class="mb-0">
                Copyright © 2024 | Design By ERPGo
            </p> --}}
...
<script src="{{ url('Modules/LandingPage/Resources/assets/js/plugins/popper.min.js') }}"></script>
<script src="{{ url('Modules/LandingPage/Resources/assets/js/plugins/bootstrap.min.js') }}"></script>
<script src="{{ url('Modules/LandingPage/Resources/assets/js/plugins/feather.min.js') }}"></script>
<script src="{{ url('Modules/LandingPage/Resources/assets/js/plugins/notifier.js') }}"></script>
<script src="{{ url('Modules/LandingPage/Resources/assets/assets/swiper/dist/js/swiper-bundle.min.js') }}"></script>
