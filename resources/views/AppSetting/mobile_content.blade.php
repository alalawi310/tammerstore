    ...
    <div class="row">
                    ...
                    <ul class="nav nav-pills w-100 flex-md-nowrap gap-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            @if (env('IS_MOBILE') == 'yes')
                                <a href="#api_url" class="nav-link btn-sm f-w-600 @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-home-tab')) active @endif" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                                    {{ __('API URL') }}
                                </a>
                            @endif
                        </li>
                        <li class="nav-item" role="presentation">
                            @if (env('IS_MOBILE') == 'yes')
                                <a href="#App_Setting" class="nav-link btn-sm f-w-600 @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-profile-tab')) active @endif" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                                    {{ __('Date Format') }}
                                </a>
                            @endif
                        </li>
                        <li class="nav-item" role="presentation">
                            @if (env('IS_MOBILE') == 'yes')
                                <a href="#Firebase_setting" class="nav-link btn-sm f-w-600 @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-firebase-tab')) active @endif" id="pills-firebase-tab" data-bs-toggle="pill" data-bs-target="#pills-firebase" type="button" role="tab" aria-controls="pills-firebase" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            @if (env('IS_MOBILE') == 'yes')
                                <a href="#Main_Page_Content" class="nav-link btn-sm f-w-600 @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-main-tab')) active @endif" id="pills-main-tab" data-bs-toggle="pill" data-bs-target="#pills-main" type="button" role="tab" aria-controls="pills-main" aria-selected="false">
                                    {{ __('Main Screen') }}
                                </a>
                            @endif
                        </li>
                        <li class="nav-item" role="presentation">
                            @if (env('IS_MOBILE') == 'yes')
                            <a href="#Product_Page_Content" class="nav-link btn-sm f-w-600 @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-product-tab')) active @endif" id="pills-product-tab" data-bs-toggle="pill" data-bs-target="#pills-product" type="button" role="tab" aria-controls="pills-product" aria-selected="false">
                                {{ __('Product Screen') }}
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#loyality_program_json" class="nav-link btn-sm f-w-600 @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-loyal-tab')) active @endif" id="pills-loyal-tab" data-bs-toggle="pill" data-bs-target="#pills-loyal" type="button" role="tab" aria-controls="pills-loyal" aria-selected="false">
        ...
        <div class="col-xl-12">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-home-tab')) active show @endif" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    @if (env('IS_MOBILE') == 'yes')
                        <div id="api_url">
                            <div class="card">
                ...
                <div class="tab-pane fade @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-profile-tab')) active show @endif" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @if (env('IS_MOBILE') == 'yes')
                        <div id="App_Setting">
                            <div class="card">
                                <div class="card-header">
                ...
                <div class="tab-pane fade @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-firebase-tab')) active show @endif" id="pills-firebase" role="tabpanel" aria-labelledby="pills-firebase-tab">
                    @if (env('IS_MOBILE') == 'yes')
                ...
                <div class="tab-pane fade @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-main-tab')) active show @endif" id="pills-main" role="tabpanel" aria-labelledby="pills-main-tab">
                    @if (env('IS_MOBILE') == 'yes')
                ...
                <div class="tab-pane fade @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-product-tab')) active show @endif" id="pills-product" role="tabpanel" aria-labelledby="pills-product-tab">
                    @if (env('IS_MOBILE') == 'yes')
                ...
                <div class="tab-pane fade @if(isset($app_setting_tab) && ($app_setting_tab == 'pills-loyal-tab')) active show @endif" id="pills-loyal" role="tabpanel" aria-labelledby="pills-loyal-tab">
                    @if (env('IS_MOBILE') == 'yes')
