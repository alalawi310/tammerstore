             ...
             <div class="mini-wish-details" style="color: black;">
                ...
                <div class="pvarprice d-flex align-items-center justify-content-between">
                   <div class="price">
                      ...
                      <ins>{{ $item->final_price }}<span class="currency-type">{{ $currency_name }}</span></ins><del>{{ currency_format_with_sym(($item->original_price ?? 0) , $store->id, $currentTheme) ?? SetNumberFormat($item->original_price) }}</del>
                   </div>
