...
use Modules\LandingPage\Http\Controllers\MenuPagesController;
use Modules\LandingPage\Http\Controllers\OwnerMenuController;
...
*/
   Route::get('landing/pages/{slug}', 'CustomPageController@customPage')->name('custom.pages');
    ...
    Route::resource('ownermenus', OwnerMenuController::class);
