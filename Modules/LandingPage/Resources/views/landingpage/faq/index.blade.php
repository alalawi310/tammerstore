                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-3 justify-content-end d-flex">
                                        <a href="javascript::void(0);" data-size="lg" data-url="{{ route('faq_create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" data-title="{{__('Create Faq')}}"  class="btn btn-sm btn-primary">
