...
@section('action-button')
    {{-- @permission('Create DeliveryBoy') --}}
        <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{__('Create DeliveryBoy')}}"
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        @permission('Delete Deliveryboy') --}}
                                            ...
                                            <a href="#" class="bs-pass-para dropdown-item bg-danger show_confirm"
