...
@section('action-button')
    ...
    @if (auth()->user()->type == 'super admin' && ((isset($setting['is_stripe_enabled']) && $setting['is_stripe_enabled'] == 'on') ||
            ...
            (isset($setting['is_nepalste_enabled']) && $setting['is_nepalste_enabled'] == 'on') || (isset($setting['is_khalti_enabled']) && $setting['is_khalti_enabled'] == 'on') || (isset($setting['is_payhere_enabled']) && $setting['is_payhere_enabled'] == 'on') || (isset($setting['is_authorizenet_enabled']) && $setting['is_authorizenet_enabled'] == 'on') || (isset($setting['is_tap_enabled']) && $setting['is_tap_enabled'] == 'on') || (isset($setting['is_phonepe_enabled']) && $setting['is_phonepe_enabled'] == 'on') || (isset($setting['is_paddle_enabled']) && $setting['is_paddle_enabled'] == 'on') || (isset($setting['is_paiementpro_enabled']) && $setting['is_paiementpro_enabled'] == 'on') || (isset($setting['is_fedpay_enabled']) && $setting['is_fedpay_enabled'] == 'on') || (isset($setting['is_cinetpay_enabled']) && $setting['is_cinetpay_enabled'] == 'on') ||
        ...
        <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
            <a href="{{ route('plan.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row-reverse gap-2 active-tag mb-3 align-items-center">
                                ...
                                @if (\Auth::user()->type != 'admin')
                                    ...
                                    <div class="d-inline-flex align-items-center">
                                        <a class="btn btn-sm btn-icon btn-info"
                                            ...
                                            title="{{ __('Edit') }}" data-bs-toggle="tooltip" title="Edit">
                                    ...
                                    @if ($plan->price > 0)
                                        <div class="">
                                            ...
                                            <a href="#!"
                                                class="bs-pass-para btn btn-danger show_confirm btn-icon btn-sm" data-bs-toggle="tooltip" title="Delete">
                                ...
                                @if (\Auth::user()->type == 'super admin')
                                    <div class="form-check form-switch custom-switch-v1 float-end" data-bs-toggle="tooltip" title="Enable/Disable">
                                        ...
                                        <td class="text-center">
                                            @if ($order->receipt != 'free coupon' && $order->payment_type == 'STRIPE')
                                                <a href="{{ $order->receipt }}" title="Invoice" target="_blank"
                                                    ...
                                                    title="{{ __('Invoice') }}"><i class="fas fa-file-invoice"></i> </a>
                                            ...
                                            @elseif ($order->payment_type == 'Bank Transfer')
                                                <a href="{{ asset($order->receipt) }}" class="btn  btn-outline-primary" data-bs-toggle="tooltip"
                                                                title="{{ __('Invoice') }}"
                                                    target="_blank">
