            ...
            <div class="row">
                <div class="col-md-5 col-12">
                    <div class="common-banner-content">
                        ...
                        <p>{{ __('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown.') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                @php
                    ...
                    if ($customer) {
                        $DeliveryAddress = \App\Models\DeliveryAddress::where(
                            'customer_id',
                            auth('customers')->user()->id,
                        )
                            ->orderBy('id', 'desc')
                            ->first();
                    }
                    ...
                    <div class="contact-left-inner row">
                        <ul class="col-sm-6 col-12">
                            <li>
                                <h4> {{ __('Call us:') }} </h4>
                                <p><a
                                        href="tel:+48 0021-32-12">{{ isset($customer->mobile) ? $customer->mobile : '+48 0021-32-12' }}</a>
                                </p>
                            ...
                            <li>
                                <h4> {{ __('Email:') }} </h4>
                                <p><a
                                        href="mailto:shop@company.com">{{ isset($customer->email) ? $customer->email : 'shop@company.com' }}</a>
                                </p>
                            </li>
                        </ul>
                        <ul class="col-sm-6 col-12">
                            <li>
                                <h4> {{ __('Address:') }} </h4>
                                <p class="address">
                                    {{ isset($DeliveryAddress->address) ? $DeliveryAddress->address : 'Marigold Lane,Coral Way, Miami,Florida, 33169' }}
                                </p>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="{{ old('email') }}" placeholder="shop@company.com" required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" placeholder="How can we help?" rows="8">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-8   col-12">
                                    <div class="checkbox-custom">
                                        ...
                                        <label for="ch1">
                                            <span> {{ __('I have read and agree to the') }} <a href="">
                                                    {{ __('Terms & Conditions.') }} </a> </span>
                                        </label>
                                    </div>
                                </div>
