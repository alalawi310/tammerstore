                    ...
                    @include('front_end.hooks.checkout_hide_field')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="checkbox-custom">
                                                                    <input type="checkbox" id="da"
                                                                        name="delivery_and_billing" value="{{ old('delivery_and_billing') }}"
                        ...
                        <div class="set has-children comfirm_list_tab">
                            ...
                            <div class="acnav-list comfirm_list_data">
                                ...
                                <input type="hidden" class="payment_type payment_types" value="{{ old('payment_type') }}" name="payment_type" id="payment_type" >
                                <input type="hidden" class="method_id" id="method_id" value="{{ old('method_id') }}" name="method_id" >
                                <div class="form-container">
                                    <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
