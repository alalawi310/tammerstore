...
class Product extends Model
{
    ...
    public static function bestseller_guest($theme_id = null, $storeId, $per_page = '6', $destination = 'app')
    {
    ...
    public static function ProductPrice($theme, $slug, $productId,$variantId = 0,$price=0)
    {
        ...
        $sale_product = \App\Models\FlashSale::where('theme_id', $store->theme_id)
    ...
    public static function GetLatProduct($theme, $slug = null, $no = 1)
    {
        ...
        return view('front_end.sections.home_latest_product', compact('currentTheme','theme', 'storeId','slug', 'latest_pro'))->render();
    }
    ...
    public static function productTaxIncludeAmount($theme, $slug = null, $amount, $taxId)
    {
        $storeId = getCurrenctStoreId($slug);
        $tax_price = 0;
