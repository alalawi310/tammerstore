...
@section('action-button')
    ...
    <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
        <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{__('Add Menus')}}"
            data-url="{{ route('ownermenus.create') }}" data-toggle="tooltip" title="{{ __('Create Menus') }}">
                                            ...
                                            <div class="accordion-body">
                                                @foreach ($pages as $page_id => $page)
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        {!! Form::label('pageCheck' . $page_id, $page['menubar_page_name'], ['class' => 'custom-control-label']) !!}
                                                    </div>
                                                @endforeach
