...
class DashboardController extends Controller
{
    ...
    public function SearchProduct(Request $request)
    {
        ...
        $products = Product::where('theme_id', $theme_id)->where('store_id', $request->store_id)->where('category_id', $request->category_id)->where('product_type',null)->get()->toArray();
        if (!empty($products)) {
            return $this->success($products);
        } else {
            return $this->error(['message' => 'Product not found.']);
    ...
    public function DeleteProductBrand(Request $request)
    {
        ...
        if (!empty($productBrand)) {
            $productBrand->delete();
            return $this->success(['message' => 'Product Brand deleted successfully!.']);
        } else {
            return $this->error(['message' => 'Product Brand data not found.']);
        }
    }
    ...
    public function AddProductLable(Request $request)
    {
        ...
        $productLabel->save();
        return $this->success([
            'message' => 'Product Label successfully created.'
        ]);
    }
    public function UpdateProductLable(Request $request)
    {
        ...
        return $this->success([
            'message' => 'Product Label successfully updated.'
        ]);
    }
    public function DeleteProductLable(Request $request){
        ...
        if (!empty($productLabel)) {
            ...
            return $this->success(['message' => 'Product Label Deleted successfully']);
        } else {
            return $this->error(['message' => 'Product Label data not found.']);
        }
    }
