...
<div class=" text-end  gap-2 d-flex all-button-box justify-content-md-end justify-content-center">
    ...
    @permission('brand import')
        @include('importexport::import.brand_import',['module'=>'brand'])
    @endpermission
    @permission('brand export')
        @include('importexport::export.brand_export',['module'=>'brand'])
    @endpermission
@endif
                            ...
                            <tbody>
                                @foreach ($productBrands as $productBrand)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset($productBrand->logo) }}" width="40px" height="40px">
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <button class="btn btn-sm btn-info"
                                                ...
                                                <i class="ti ti-pencil" data-bs-toggle="tooltip" title="{{__('Edit Brand')}}"></i>
                                            </button>
                                            {{-- @endpermission --}}
