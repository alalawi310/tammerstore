...
class QRCode
{
    ...
    private static $apiVersion2 = '2024-07-31';
     ...
     * For API version 2024-07-31: reference_id, type, currency, amount (only if type = DYNAMIC).
     *
     ...
     *   'amount' => int,
     *   'qr_string' => string,
     *   'reference_id' => string, (only for API version 2024-07-31)
     *   'currency' => string, (only for API version 2024-07-31)
     *   'channel_code' => string, (only for API version 2024-07-31)
     *   'expires_at' => date, (only for API version 2024-07-31)
     *   'type' => 'DYNAMIC' || 'STATIC',
    ...
    public static function create($params = [])
    {
        ...
        if ($params['api-version'] === QRCode::$apiVersion1) {
            ...
            if (array_key_exists('callback_url', $params)) {
                $message = 'The API version 2024-07-31 does not support passing callback URL in the request. Please set the callback URL from your Xendit Dashboard instead.';
                throw new InvalidArgumentException($message);
            }
        } else {
     ...
     *  For API Version 2024-07-31, this should be the ID with `qr_` prefix that is returned after creating the QR Code.
