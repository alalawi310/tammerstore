...
class Order extends Model
{
    ...
    public static function order_detail($order_id = 0)
    {
        ...
        if (!empty($order)) {
            ...
            if (module_is_active('PartialPayments')) {
                $value = \Modules\PartialPayments\app\Http\Controllers\PartialPaymentsController::ManageOrderStatusValue($order_array,$order);
    ...
    public static function order_status_change($date = [])
    {
        ...
        if (!empty($order)) {
            ...
            if (module_is_active('PartialPayments')) {
                $return = \Modules\PartialPayments\app\Http\Controllers\PartialPaymentsController::ManageOrderStatus($date);
                return $return;
            }
        } else {
            $return['status'] = 'error';
