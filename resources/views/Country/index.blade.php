                    ...
                    <ul class="nav nav-pills w-100 gap-3" id="pills-tab" role="tablist">
                        <li class="nav-item " role="presentation">
                            <a href="#Country_Setting"
                                class="nav-link text-center f-w-600 @if(isset($country_active_tab) && ($country_active_tab == 'pills-country-tab')) active @endif"
                        ...
                        <li class="nav-item " role="presentation">
                            <a href="#State_Setting"
                                class="nav-link text-center f-w-600 @if(isset($country_active_tab) && ($country_active_tab == 'pills-state-tab')) active @endif"
                        ...
                        <li class="nav-item " role="presentation">
                            <a href="#City_Setting"
                                class="nav-link text-center f-w-600 @if(isset($country_active_tab) && ($country_active_tab == 'pills-city-tab')) active @endif"
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade @if(isset($country_active_tab) && ($country_active_tab == 'pills-state-tab')) show active @endif" id="pills-state" role="tabpanel" aria-labelledby="pills-state-tab">
                    <div id="State_Setting">
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="row card-header-wrp align-items-center justify-content-between ">
                                    <div class="col-sm-4 col-12">
                                        <h5>{{ __('State Settings') }}</h5>
                                    </div>
                                        ...
                                        <form method="GET" action="{{ route('countries.index') }}" accept-charset="UTF-8"
                                            ...
                                            <div class="d-flex align-items-center justify-content-end gap-2 px-2">
                                                <div class="col-lg-6 col-sm-8 col-10">
                                                    <div class="btn-box d-flex gap-1 align-items-center">
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex gap-1">
                                                            <button class="btn btn-sm btn-info"
                                                                ...
                                                                data-size="md" data-ajax-popup="true"
                                                                data-title="{{ __('Edit State') }}" data-bs-toggle="tooltip"
                                                                title="{{__('Edit') }}">
                                                                <i class="ti ti-pencil"></i>
                                                            </button>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex gap-1">
                                                            <button class="btn btn-sm btn-info"
                                                                ...
                                                                data-size="md" data-ajax-popup="true"
                                                                data-title="{{ __('Edit City') }}" data-bs-toggle="tooltip"
                                                                title="{{__('Edit') }}">
                                                                <i class="ti ti-pencil"></i>
                                                            </button>
        ...
        <script type="text/javascript">
            $(document).on("change", '.country', function() {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    headers: {
                        // 'X-CSRF-TOKEN': jQuery('#token').val() // Uncomment if needed
                    },
                    data: {
                        'country': country,
                        "_token": "{{ csrf_token() }}",
                    ...
                    success: function(data) {
                        $('#loader').fadeOut();
                        // Replace the entire table with new content
                        $('#stateDataTable').html('');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        try {
                            ...
                            // Initialize new DataTable instance
                            new simpleDatatables.DataTable(".dataTable-6");
                        } catch (e) {
                            console.error('DataTable- Initialization Error:', e);
                        }
                    },
