        ...
        <div class="card align-middle p-3">
            <ul class="nav nav-pills pb-3" id="pills-tab" role="tablist">
                <li class="nav-item px-1">
                    <a class="nav-link text-capitalize  {{ ( $module == 'General') ? ' active' : '' }} " href="{{ route('manage.language',[$currantLang]) }}">{{ __('General') }}</a>
                </li>
                @foreach ($modules as $item)
                    ...
                    @endphp
                    <li class="nav-item px-1">
                        <a class="nav-link text-capitalize  {{ ( $module == ($item)) ? ' active' : '' }} " href="{{ route('manage.language',[$currantLang,$item]) }}">{{$item}}</a>
                    </li>
                @endforeach
            </ul>
        </div>
