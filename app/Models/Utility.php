...
use Modules\ProductAffiliate\app\Models\AffiliateSetting;
use Modules\ProductAffiliate\app\Models\TransactionOrder;
use Modules\ProductAffiliate\app\Models\AffiliateTransaction;
use Modules\AuctionProduct\app\Models\AuctionProductOrder;
...
class Utility extends Model
{
    ...
    public static function Seting()
    {
        ...
        $defaults = [
            ...
            'title_text' => (env('APP_NAME') ?? 'Tammer store'),
            'footer_text' => (env('APP_NAME') ?? 'Tammer store'),
            'SITE_RTL' => 'off',
            'cust_theme_bg' => 'on',
            'cust_darklayout' => 'off',
            'color' => 'theme-3',
            ...
            'sms_setting_enabled' => '',
            'theme_image' => 'themes/'.APP_THEME().'/theme_img/img_1.png'
    ...
    {
        try {
            $json = json_decode(file_get_contents('https://demo.tammerofficial.com/cronjob/addon.json'), true);
            if (!empty($json)) {
                return $json;
            }
        } catch (\Exception $e) {
