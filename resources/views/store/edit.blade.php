...
<div class="row">
    <div class="col-12">
        <div class="form-group">
            ...
            {{Form::text('name',$user->name,array('class'=>'form-control','placeholder'=>__('Enter Name'), 'required' => 'true'))}}
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            {{Form::text('storename',$store->name,array('class'=>'form-control','placeholder'=>__('Enter Store Name'), 'required' => 'true'))}}
        </div>
    </div>
    <div class="col-12">
        <div class="form-group">
            {{Form::label('email',__('Email'),array('class'=>'form-label'))}}
            {{Form::email('email',null,array('class'=>'form-control','placeholder'=>__('Enter Email'), 'required' => 'true'))}}
        </div>
    </div>
